...
class Node {
  ...
  console.log(binarySearchTree.find(4)); //returns `Node {value: 2, right: Node, left: null}`
  console.log(binarySearchTree.find(20));
  console.log(binarySearchTree.find(123)); //returns `undefined`
  console.log(binarySearchTree.contains(6)); //returns `true`